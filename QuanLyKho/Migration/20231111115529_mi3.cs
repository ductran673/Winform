    ...
    public partial class mi3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Bút bi Thiên Long 20Cây/hộp màu xanh", "Bút bi Thiên Long" },
                    { 2L, "Thước kẻ 20cm hộp 30 cái", "Thước kẻ 20cm" },
                    { 3L, "Giấy in văn phòng 1 thùng 20 xấp", "Giấy in văn phòng" },
                    { 4L, "Bút lông viết bảng (màu xanh) hộp 10 cái", "Bút lông viết bảng (màu xanh)" },
                    { 5L, "Gôm/Bút tẩy xóa", "Gôm/Bút tẩy xóa" },
                    { 6L, "Dao kéo, Băng keo", "Dao kéo, Băng keo" },
                    { 7L, "Túi đựng hồ sơ và tài liệu", "Túi đựng hồ sơ và tài liệu" },
                    { 8L, "Sổ tay học từ vựng", "Sổ tay học từ vựng" }
                });
